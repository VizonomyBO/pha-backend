...
export const RETAILERS_OSM = 'carto-dw-ac-j9wxt0nz.shared.OpenStreetMap_Mississippi';
export const RETAILERS_USDA = 'carto-dw-ac-j9wxt0nz.shared.USDA_FamersMarkets';
